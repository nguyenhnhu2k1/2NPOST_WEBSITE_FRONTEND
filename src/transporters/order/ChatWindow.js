...
class ChatWindow extends Component {
    ...
    readMessage = (idTrans, idCus) => {
        ...
        console.log(this.state.idCustomer)
        console.log(this.state.idTransporter)
        console.log('conversationRef ', `chat/${idTrans}-${idCus}`);
        this.setState({
            messages: ''
        })
        // Truy vấn dữ liệu
                    ...
                    <div className="container py-3 chat-window-container">
                        ...
                        <div className="row">
                                        ...
                                        <div className="card-body-user">
                                            <ul className="list-unstyled mb-0">
                                                {this.props.chatList && this.props.chatList.map((chat, index) =>
                                                    <li className={`p-2 border-bottom user-chat-list ${this.state.choseCustomerChat === index ? 'action' : ''} `} onClick={() => this.chooseMessage(chat, index)}>
                                                        <Link href="#!" className="d-flex justify-content-between">
                                                            <div className="d-flex flex-row">
                                                                ...
                                                                <div className="pt-1">
                                                                    ...
                                                                    <p className="small text-muted">{this.props.lastMessage[index].text}</p>
                                                                </div>
                                                            </div>
                            ...
                            <div className="col-md-6 col-lg-7 col-xl-8 card-message">
                                <CustomScrollbars style={{ height: '100vh', width: '100%' }} ref={this.customScrollbarsRef}>
                                    <ul className="list-unstyled">
                                        {
                                            this.state.messages ? (
                                                        ...
                                                        <li className="d-flex justify-content-between mb-4" key={index}>
                                                            ...
                                                            <div className="card w-100">
                                                                <div className="card-header d-flex justify-content-between p-3" style={{ backgroundColor: '#0dcaf0' }}>
                                                                    <p className="fw-bold mb-0">{this.state.info.usernameCus}</p>
                                                        ...
                                                        <li className="d-flex justify-content-between mb-4" key={index}>
                                                            <div className="card w-100">
                                                                <div className="card-header d-flex justify-content-between p-3" style={{ backgroundColor: '#c5c1c1' }}>
                                                                    <p className="fw-bold mb-0">{this.state.info.usernameTrans}</p>
                                                ...
                                                <div style={{ textAlign: 'center' }} >
                                                    <h4 style={{ color: '#0d6efd' }}>{this.props.order.user.userName}</h4>
                                        ...
                                        <button type="button" className="btn btn-info btn-rounded float-end btn-send" onClick={this.handleSendMessage}>
